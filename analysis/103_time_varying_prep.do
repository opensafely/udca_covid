...
* Sensitivity analysis - create file to take out people with missing ethnicity, BMI or smoking for 120 file 

use `tempfile', clear
describe 
gen missing_ebs = 0
replace missing_ebs=1 if ethnicity==0

* BMI categories
* assume BMI's less than 10 are incorrect and set to missing 
sum bmi, d 
replace bmi = . if bmi<10
replace missing_ebs = 1 if bmi==.
